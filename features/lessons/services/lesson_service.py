...
ConversationItem = ConversationInput | dict[str, Any]
VocabularyItem = VocabularyInput | dict[str, Any]
GrammarItem = GrammarInput | dict[str, Any]
...
class LessonCreateInput:
    ...
    vocabularies: list[VocabularyItem] = field(default_factory=list)
    grammars: list[GrammarItem] = field(default_factory=list)
